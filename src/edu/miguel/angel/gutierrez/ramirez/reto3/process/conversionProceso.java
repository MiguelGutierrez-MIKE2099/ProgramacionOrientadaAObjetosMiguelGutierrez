 ...
 * @class conversionProceso clase con métodos de conversión de números en diferentes bases numéricas
 */
public class conversionProceso {
     ...
     * @param decimal número en base decimal a ser convertido en base binaria
